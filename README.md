...
Wir werden *Git* nicht näher betrachten, vollständigkeitshalber beschreibe ich aber kurz, um was es geht: Beim Schreiben von Software arbeitet man in der Regel mit einer bestimmten Anzahl Dateien, die alle einen Teil des Quelltextes enthalten: Vielleicht legt die Länge des Quelltextes eine Teilung in mehrere Dokuente nahe, vielleicht gilt es, funktionalen Unterschieden Rechnung zu tragen oder es werden verschiedene Programmiersprachen kombiniert. Jedes Dokument umfasst wiederum Sektionen, Teilbereiche, Kommentare etc. – es handelt sich um komplexe Texte.

Diese Teile des Quelltextes müssen laufend gerüft und angepasst werden. Durch die Komplexität der Problemstellungen – meist gliedert sich ein Problem in eine Reihe untergeordneter Teilbereiche, die der Reihe nach behandelt werden müssen – ergibt sich ein ganz grundlegendes, übergeordnetes Problem: was geschieht, wenn man eine Reihe von Änderungen durchführt, und merkt, dass man sich verrannt hat? Wie kommt man schnell auf eine vorherige Version der Dokumente zurück? Was, wenn mehrere Programmierer an den gleichen Dokuemten arbeiten?
